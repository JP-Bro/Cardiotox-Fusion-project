"""
create_notebook.py -- Generate a clean, fully-functioning Jupyter Notebook
for the Phase 1 Usability Audit and Splits, structured cell-by-cell.
"""
import os
import json
...
notebook_path = os.path.join(PROJECT_ROOT, "notebooks", "phase1_usability_and_splits.ipynb")
with open(notebook_path, "w") as f:
    json.dump(notebook, f, indent=2)
print("Notebook created successfully at:", notebook_path)
